...
class MyNotificationManager {
    ...
    public void showNotification(String title, String notification, Intent intent){
        ...
        Notification mNotification = builder.setSmallIcon(MyFirebaseMessagingService.GetTopicIcon())
                .setAutoCancel(true)
                .setContentIntent(pendingIntent)
                .setContentTitle(title)
                .setContentText(notification)
                .setLargeIcon(BitmapFactory.decodeResource(ctx.getResources(),MyFirebaseMessagingService.GetTopicIcon()))
                .build();
